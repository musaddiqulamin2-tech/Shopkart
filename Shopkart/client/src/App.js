...
function App() {
  ...
  const [loadingAnimationType, setLoadingAnimationType] = useState('default');
  ...
  const handleAddToCart = (product) => {
    setShowLoadingAnimation(true);
    setLoadingAnimationType('product-open');
  ...
  const handleCheckout = () => {
    ...
    setShowLoadingAnimation(true);
    setLoadingAnimationType('order-success');
  ...
  if (showLoadingAnimation) {
    return <LoadingAnimation type={loadingAnimationType} message={loadingMessage} onComplete={() => setShowLoadingAnimation(false)} />;
  }
  ...
  if (currentPage === 'thankyou') {
    ...
    return (
      <ModernOrderConfirmation
        ...
        supportEmail="support@shopkart.com"
    ...
    return (
      <div className="min-h-screen bg-gradient-to-r from-blue-600 to-blue-800 flex items-center justify-center p-4">
        <div className="bg-white p-8 rounded-lg shadow-2xl w-full max-w-md">
          <h1 className="text-4xl font-bold text-center mb-8 text-blue-600">Shopkart</h1>
  ...
  if (currentPage === 'signup') {
    return (
      <div className="min-h-screen bg-gradient-to-r from-green-600 to-green-800 flex items-center justify-center p-4">
        <div className="bg-white p-8 rounded-lg shadow-2xl w-full max-w-md">
          <h1 className="text-4xl font-bold text-center mb-8 text-green-600">Shopkart</h1>
  ...
  const Navbar = () => (
    <nav className="bg-gradient-to-r from-indigo-600 to-purple-600 p-4 text-white flex justify-between px-6 items-center shadow-2xl sticky top-0 z-50 backdrop-blur-sm">
      <div className="flex items-center space-x-4">
        <div className="bg-white/20 text-white rounded-full w-14 h-14 flex items-center justify-center font-extrabold text-2xl shadow-md">S</div>
        <div>
          <h1 className="text-2xl font-extrabold tracking-tight">Shopkart</h1>
  ...
  if (currentPage === 'home') {
    return (
      <div className="bg-gray-100 min-h-screen font-sans">
        ...
        {/* BANNER COMPONENT */}
        <Banner 
          onShopNow={() => setCurrentPage('categories')}
          onLearnMore={() => window.scrollTo({top: document.body.scrollHeight, behavior: 'smooth'})}
        />
        ...
        <div className="p-10">
          ...
          {/* FEATURES SECTION */}
          <div className="mb-10">
            <h2 className="text-3xl font-bold mb-6 text-center">✨ Why Choose Shopkart?</h2>
