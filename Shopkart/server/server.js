...
// JWT Secret
const JWT_SECRET = process.env.JWT_SECRET || 'your_secret_key_shopkart';
...
app.get('/api/db-status', (req, res) => {
  ...
  res.json({ state, status: states[state], host: mongoose.connection.host || null, port: mongoose.connection.port || null });
});
